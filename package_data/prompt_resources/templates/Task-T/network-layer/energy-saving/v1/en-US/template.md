...
Requirement:
Define the quantitative or qualitative goals the task must achieve. Quantitative and qualitative goals cannot be selected at the same time, and the default is a qualitative goal. The specific description of energy saving goals is as follows:
...
4. Rate guarantee goal: the minimum downlink throughput target that must be guaranteed and its effective time period.
    - For the area-level setting, the following information needs to be provided:    
      Option 1: Time-segmented rate guarantee goal (required)    
      Example: Time-segmented rate guarantee goal: {00:00~06:00,2Mbps}, {06:00~18:00,10Mbps}, {18:00~00:00,20Mbps}    
      Option 2: Full-period rate guarantee goal (required)
    ...
    - For the site-level setting, the following information needs to be provided:    
      ...
      Example:    
      - Site list 1: ["Site Name 1", "Site Name 2"], Time-segmented rate guarantee goal: {00:00~06:00,2Mbps}, {06:00~18:00,10Mbps}, {18:00~00:00,20Mbps}, Background event: power outage from 00:00 to 06:00.
      - Site list 2: ["Site Name 3", "Site Name 4"], Time-segmented rate guarantee goal: {01:00~06:00,2Mbps}, {06:00~18:00,10Mbps}, {19:00~00:00,20Mbps}, Background event: power outage from 00:00 to 06:00.
...
Requirement:
When the task object is a geographic/logical area, output the intent report for the network energy saving task. The intent report should contain the following information:
